<?php
/*
** Description  : Send messages page
**
** $Id: messages.php 274 2015-02-03 08:56:38Z paul $
**
*/
...
<head>
    ...
    <script type="text/javascript" src="m/js/communication.js"></script>
...
<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <span class="divider">/</span>
        <li>Send Communication</li>
    </ul><!-- Breadcrumbs -->

    <div class="row" style="padding-top:10px">
        <div class="span8" id="ordersPanel">
            <?php require_once("m/php/send_message_panel.php"); ?>
        </div><!-- Send message span -->
