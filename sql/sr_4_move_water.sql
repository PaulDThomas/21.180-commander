...
CREATE PROCEDURE `asupcouk_asup`.`sr_4_move_water` (sr_gameno INT, sr_powername TEXT, sr_terrname_from TEXT, sr_terrname_to TEXT, sr_major INT, sr_minor INT)
BEGIN
sproc:BEGIN

-- $Id: sr_4_move_water.sql 242 2014-07-13 13:48:48Z paul $
